...
<body>
    ...
    <div class="container">
        <h1>Welcome to IKGPTU Amritsar Campus - NSS (National Integration Camp) </h3>
        <p>Enter your details and submit this form to confirm your participation in this camp </p>
        <?php
        if($insert == true){
